function buildAngularLoader(js_list, app_name){
    //This function wraps the angular loader functon and allows you to specify an array of js files to load (make sure angularjs is first).
    // You must also specify the app_name to load.
